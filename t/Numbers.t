...
use Format::Util::Numbers qw(roundnear roundeven commas to_monetary_number_format formatnumber financialrounding);
...
subtest 'roundeven' => sub {
    is(roundeven(0,     345.56789), 345.56789, 'No rounding is correct.');
    is(roundeven(1,     345.56789), 346,       'Ones is correct.');
    is(roundeven(0.01,  345.56789), 345.57,    'Hundredths rounding is correct.');
    is(roundeven(0.02,  345.56789), 345.56789, 'Two hundredths rounding is not supported.');
    is(roundeven(10,    345.56789), 345.56789, 'Rounding supported till 10 digits.');
    is(roundeven(0,     undef),     undef,     'Rounding undef yields undef.');
    is(roundeven(1e-2,  10.456),    10.46,     'Rounding with exponential precision');
    is(roundeven(-1e-2, 10.456),    10.456,    'incorrect precision returns same value back');
};
